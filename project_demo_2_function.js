...
// name of building - this can come from on click in the map properties.name
// this function will return the matching image path from the look up table above
/*var param = "Botany Building"; // hardcoded for now but replace with property name from map
building_lookup.forEach( function (obj){
	if (obj[param] != undefined ){
		var pic = obj[param];
		console.log(pic);
		// draw the image in the div on the UI
		var img = new Image();
		document.getElementById('building_image').appendChild(img);
		img.src = pic;
	};	
});*/